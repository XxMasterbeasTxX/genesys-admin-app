...
const DIVISION_OBJECT_EDIT = {
  ...
  DATATABLE: "architect:datatable:edit", FLOW: "architect:flow:edit", FLOWMILESTONE: "architect:flowMilestone:edit",
  FLOWOUTCOME: "architect:flowOutcome:edit", EMERGENCYGROUP: "routing:emergencyGroup:edit",
  EXTENSIONPOOL: "telephony:extensionPool:edit", MANAGEMENTUNIT: "wfm:managementUnit:edit",
  BUSINESSUNIT: "wfm:businessUnit:edit", SCHEDULE: "routing:schedule:edit", SCHEDULEGROUP: "routing:scheduleGroup:edit",
