...
- **WebRTC Phones — Delete** *(Master Admin only)* — Find and remove WebRTC phones with no user, or whose user is deleted or inactive, optionally narrowed by site, after a per-category review and a typed confirmation
