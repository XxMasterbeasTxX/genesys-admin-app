...
| 94 | Interaction Totals | Select org; pick date range + optional filters; click Load Totals; bar charts for Media Type, Direction, Routing Method; Export Excel with title rows; email with attachment; schedule automation with period preset |
