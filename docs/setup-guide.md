...
| 87 | Copy Role (Same Org) — Make Hourly Interacting | Select a role; check "Make Hourly Interacting"; create; disqualifying permissions stripped; `billing:user:hourlyInteracting` added; collapsible summary shown |
