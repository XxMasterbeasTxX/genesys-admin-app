...
export const NAV_TREE = [
  {
    ...
    children: [
      ...
      { label: "Test", path: "test", enabled: true, access: "data-actions.test" },
    ],
  },
  {
    label: "Data Tables",
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        enabled: true,
        children: [
          { label: "Billing Period",        path: "single-org",        enabled: true, access: "export.billing.singleOrg" },
      ...
      },
      {
        ...
        children: [
          ...
          { label: "Queues/Skills", path: "queues-skills", enabled: true, access: "export.users.queuesSkills" },
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Article 15 - Export Reader", path: "export-reader", enabled: true, access: "gdpr.exportReader" },
    ],
  },
  {
    label: "Roles",
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { label: "Manage Templates", path: "add-users-to-templates", enabled: true, access: "users.rolesSkills.addUsersToTemplates" },
          { label: "Template Schedules", path: "template-schedules", enabled: true, access: "users.rolesSkills.templateSchedules" },
          { label: "Copy from User", path: "copy-from-user", enabled: true, access: "users.rolesSkills.copyFromUser" },
        ],
      },
    ],
  },
  {
    ...
    children: [
      ...
      { label: "Super User Access", path: "supervisor-access", enabled: true, access: "customers.supervisorAccess" },
    ],
  },
  {
    label: "Utilities",
  ...
  // A customer Master Admin's own section (accessConfig.CUSTOMER_ADMIN_KEYS):
  // the Super User scope for their org, and their org's users — role and
  // pages only, never who is named. Absent for Super Users and for every
  // internal session, who have Customers › … instead.
  {
    ...
    enabled: true,
    children: [
      { label: "Super User Access", path: "supervisor-access", enabled: true, access: "administrator.supervisorAccess" },
