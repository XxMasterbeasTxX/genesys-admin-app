/**
 * Shared Excel styling for export pages.
 *
 ...
 *
 * Used by: allGroups.js, allRoles.js, lastLogin.js (browser-side pages)
 */
 ...
 * @returns XLSX workbook object (from window.XLSX / xlsx-js-style).
 */
export function buildStyledWorkbook(wsData, sheetName) {
