...
export const RELEASE_NOTES = [
  {
    ...
    changes: [
      ...
      "An optional Site filter narrows the sweep; leave it empty to cover the whole org. There is deliberately no group or division filter: both match the person holding a phone, and the phones this page looks for have nobody holding them, so either one hid every result.",
