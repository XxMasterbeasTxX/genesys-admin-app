...
export const RELEASE_NOTES = [
  {
    ...
    changes: [
      ...
      "A schedule cannot outlive the authority of whoever made it. Before each run the creator is looked up again, and the job is refused if they are no longer an active user or no longer hold the phone permission. Schedules created by internal staff report that the check could not be made unless internal-org credentials are configured; see the setup guide.",
