...
export const RELEASE_NOTES = [
  {
    ...
    changes: [
      ...
      "Emptying a queue no longer searches six months every time. It asks the queue how old its oldest interaction is and looks back exactly that far — a queue whose oldest has been waiting a day is searched a day back, not half a year. The six historical passes that produced the wait were, for such a queue, searching for something that could not be there. The status line says how far it looked, and a “Full 6-month scan” box forces the old behaviour when you are chasing something you think the queue is not showing you.",
      "The queue’s own depth now sits beside the result — “4 match · 3.091 waiting in queue · oldest 23h”. Without it, a filter that matched nothing looked exactly like a queue that was already empty.",
