...
export const RELEASE_NOTES = [
  {
    ...
    changes: [
      ...
      "Each list in Get Lists is now gated on its own permission rather than the page requiring all of them. Previously someone entitled to one list but not another lost the whole page.",
