...
- **WebRTC Phones — Create** — Analyse an org's active users, licences and existing phones to report exactly who needs a WebRTC phone, then bulk-create for the reviewed selection after confirmation; skips users who already have one, hold only a collaborate licence, or hold none, with Excel log export
