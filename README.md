...
│   │   ├── deployment/
│   │   │   ├── basic.js             Bulk-deploy DID Pools, Divisions, Sites, Skills, Number Plans, Outbound Routes, Schedules, Schedule Groups, Wrapup Codes, Queues (upsert by name where supported)
