...
- **Top-level menu groups** — Data Actions, Data Tables, Deployment, Divisions, Export, Interactions, and Phones each have their own top-level nav section
